"""Hash primitives used throughout Bitcoin script and transaction handling.
...
def sha1(data: bytes) -> bytes:
    """SHA-1 of ``data`` (used only by the disabled/rare ``OP_SHA1``)."""
...
def tagged_hash(tag: str, data: bytes) -> bytes:
    ...
    Used for TapLeaf / TapBranch / TapTweak / TapSighash and Schnorr.
    """
